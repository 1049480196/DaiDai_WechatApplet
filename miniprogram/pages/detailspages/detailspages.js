// miniprogram/pages/detailspages/detailspages.js
Page({
  ...
  onLoad: function (options) {
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        } else if (res.data.pro.type_name == '其他') {
          that.setData({
            image: '../../images/_other.png'
          })
        }
  ...
  takeorder:function(e){
    var that=this;
    wx.request({
      url: getApp().globalData.urlPath + '/Receive?receive_openid=' + getApp().globalData.openid+'&id='+that.data.indexid,
      success:function(res){
        wx.showToast({
          title: '成功代代',
          icon: 'success',
